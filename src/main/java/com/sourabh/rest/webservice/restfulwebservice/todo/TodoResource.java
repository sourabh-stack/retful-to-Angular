...
public class TodoResource {
	...
	public ResponseEntity deleteTodo(@PathVariable String username, @PathVariable long id, @RequestBody Todo todo){
	...
	public ResponseEntity deleteTodo(@PathVariable String username, @RequestBody Todo todo){
